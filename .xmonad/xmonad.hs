...
myColorizer = colorRangeFromClassName
                  (0x28,0x2c,0x34) -- lowest inactive bTokyonightDarkg
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        ...
        , ("M-C-<Return>", spawn "rofi -show run") -- Rofi
    ...
    -- KB_GROUP Neovide
        , ("M-n n", spawn "neovide")          -- Neovide
        , ("M-n k", spawn "neovide ~/.config/kitty/kitty.conf")     -- Kitty config
        , ("M-n f", spawn "neovide ~/.config/fish/config.fish")     -- Fish config
        , ("M-n x", spawn "neovide ~/.xmonad/xmonad.hs")            -- Xmonad config
        , ("M-n c", spawn "neovide ~/.config/nvim/init.lua")        -- Neovim config
        , ("M-n d", spawn "neovide ~/.config/dmscripts/config")     -- Dmenu config
        , ("M-n w", spawn "neovide ~/.config/conky/xmonad/")        -- Conky config
        , ("M-n q", spawn "neovide ~/.config/qtile/config.py")      -- Qtile config
